...
var points = {
	...
	fontSize: 16,
	init: function() {
		this.x = config.itemSize + 4;
		this.y = config.itemSize + this.fontSize + 4;
	},
	draw: function() {
		canvas.ctx.fillStyle = "blue";
  		canvas.ctx.font = "bold " + this.fontSize + "px Arial";
  		canvas.ctx.fillText(this.point + " mele", this.x, this.y);
	},
	add: function() {
		this.point += 1;
	}
...
var gameover = {
	...
	fontSize: 40,
	init: function() {
		this.x = canvas.w/2 - 125;
		this.y = canvas.h/2 + this.fontSize/2;
	},
	draw: function() {
		...
		canvas.ctx.fillStyle = "red";
  		canvas.ctx.font = "bold " + this.fontSize + "px Arial";
  		console.log(this);
  		canvas.ctx.fillText("GAME OVER", this.x, this.y);
	}
}
